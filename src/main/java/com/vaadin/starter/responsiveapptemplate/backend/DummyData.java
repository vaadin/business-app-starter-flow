...
public class DummyData {
	...
	static {
		...
		for (i = 0; i < 100; i++) {
			...
			PERSONS.put(i, new Person(i, firstName, lastName, getRole(), firstName.toLowerCase() + "." + lastName.toLowerCase() + "@email.com", random.nextBoolean(), random.nextInt(500000), getDate()));
		}
