...
public class NaviTabDrawer extends NaviDrawer {
    ...
    public NaviTabItem addNaviItem(VaadinIcon icon, String text,
    ...
    public NaviTabItem addNaviItem(Image image, String text,
            Class<? extends Component> navigationTarget) {
    ...
    public NaviTabItem addNaviItem(String path, String text,
            Class<? extends Component> navigationTarget) {
    ...
    public NaviTabItem addNaviItem(NaviItem parent, String text,
            Class<? extends Component> navigationTarget) {
