...
public class Dashboard extends ViewFrame {
    ...
    private Component createContent() {
        ...
        Component salesChart = UIUtils
                .createSalesChart("Product sales for 2018", "Items Sold");
        ...
        FlexBoxLayout content = new FlexBoxLayout(progressHeader, progressChart,
                salesHeader, salesChart, items);
    ...
    private Component createProgressCharts() {
        ...
        for (String section : new String[] { "Today", "Week", "Month",
                "Year" }) {
    ...
    private Component createProgressSection(String title) {
        ...
        FlexBoxLayout chartContainer = new FlexBoxLayout(
                UIUtils.createProgressChart(value), textContainer);
        ...
        FlexBoxLayout column = new FlexBoxLayout(new Label(title),
                chartContainer);
    ...
    private Component createRecentItems() {
        Component header = createHeader(VaadinIcon.TIME_BACKWARD,
                "Recent Items");
        Component card = createTabbedList();
        ...
        FlexBoxLayout items = new FlexBoxLayout(
                new ListItem(
                        UIUtils.createIcon(IconSize.M, TextColor.TERTIARY,
                                VaadinIcon.CHART),
                        "My Weekly Report", "Last opened May 5, 2018",
                        createInfoButton()),
                new ListItem(
                        UIUtils.createIcon(IconSize.M, TextColor.TERTIARY,
                                VaadinIcon.SITEMAP),
                        "My Workflow", "Last opened May 5, 2018",
                        createInfoButton()));
