...
public class DummyData {
    ...
    private static final String[] FIRST_NAMES = new String[]{"Tereasa", "Latina", "Flo", "Harriett", "Tiffiny", "Darren", "Chau", "Annabell", "Laurena", "Janene", "Arline", "Everett", "Beatris", "Josefina", "Shera", "Traci", "Avery", "Zulma", "Cheryle", "Yuko", "Tish", "Karena", "Junie", "Francene", "Sherice", "Jacob", "Elois", "Lamonica", "Carly", "Sybil", "Adriene", "Arielle", "Patty", "Dori", "Emerald", "Edda", "Bao", "Kathrin", "Ken", "Lael", "Chia", "Larisa", "Raymond", "Judith", "Bridget", "Tana", "Windy", "Fe", "Bernardina", "Cherilyn"};
    ...
    static {
        long i = 0;
        REPORTS.put(i, new Report(i++, UIUtils.IMG_PATH + "sample-logo1.jpg", "Woocero Ltd.", LocalDate.now().minusDays(2), LocalDate.now().plusDays(14), 120000.00, "EUR"));
        REPORTS.put(i, new Report(i++, UIUtils.IMG_PATH + "sample-logo1.jpg", "Woocero Ltd.", LocalDate.now().minusDays(3), LocalDate.now().plusDays(4), 220000.00, "EUR"));
        REPORTS.put(i, new Report(i++, UIUtils.IMG_PATH + "sample-logo2.jpg", "Cemoco Exports", LocalDate.now().minusDays(5), LocalDate.now().plusDays(2), 20000.00, "EUR"));
        REPORTS.put(i, new Report(i++, UIUtils.IMG_PATH + "sample-logo1.jpg", "Woocero Ltd.", LocalDate.now().minusDays(2), LocalDate.now().plusDays(1), 7500.00, "EUR"));
        REPORTS.put(i, new Report(i++, UIUtils.IMG_PATH + "sample-logo2.jpg", "Cemoco Exports", LocalDate.now().minusDays(1), LocalDate.now().plusDays(7), 1200000.00, "EUR"));
        REPORTS.put(i, new Report(i++, UIUtils.IMG_PATH + "sample-logo2.jpg", "Cemoco Exports", LocalDate.now().minusDays(7), LocalDate.now().plusDays(2), 20000.00, "EUR"));
        REPORTS.put(i, new Report(i++, UIUtils.IMG_PATH + "sample-logo2.jpg", "Cemoco Exports", LocalDate.now().minusDays(8), LocalDate.now().plusDays(8), 12500.00, "EUR"));
