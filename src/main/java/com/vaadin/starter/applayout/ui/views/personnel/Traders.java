...
@Route(value = "traders", layout = Root.class)
@PageTitle("Traders")
public class Traders extends AbstractView {
    ...
    public Traders() {
        ...
        grid.addColumn(new ComponentRenderer<>(this::createNumber))
                .setHeader(UIUtils.createRightAlignedDiv(new Text("Trade Volume (€)")))
                .setWidth(UIUtils.COLUMN_WIDTH_L)
                .setFlexGrow(0);
    ...
    private Component createNumber(Person person) {
